...
<br>Features:
<ul>
<li>Submit structured scam reports</li>
<li>Categorised scam types (e.g. Deepfake, Voice Spoofing, Fake News)</li>
<li>Public feed of submitted reports</li>
<li>Timestamped entries</li>
<li>Mobile-first interface</li>
<li>REST API for data handling</li>
</ul>
